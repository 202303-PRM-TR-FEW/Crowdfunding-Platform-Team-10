    ...
    <div className="p-20 flex flex-col text-center lg:text-left container mx-auto">
      ...
      <div className='flex flex-row flex-wrap gap-8 justify-center py-10'>
        ...
        <div className='group/item h-60 w-60 lg:h-80 lg:w-80 rounded transition ease-in-out hover:bg-gradient-to-t hover:from-black shadow-lg ' >
          ...
          <div className=' group/edit group-hover/item:visible relative invisible hover:visible -top-16 lg:-top-20 text-center font-bold color-yellow text-base' id='hovered'>
            <p>Web Developer & Designer</p>
            <h1 className=' text-white md:text-lg lg:text-xl'>Sadık Barış Yılmaz<span className='pl-3'><Link href="https://github.com/sadikbarisyilmaz" target="_blank" className='cursor-pointer'><GitHub /></Link></span> </h1>
          </div>
        </div>
        <div className='group/item h-60 w-60 lg:h-80 lg:w-80 rounded transition ease-in-out hover:bg-gradient-to-t hover:from-black shadow-lg '>
          <div>
