...
const SummaryCard = ({ img, title, raised, goal }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center justify-center w-full gap-3 p-10 ">
      <div className="flex flex-col self-stretch gap-3 w-[295px] backdrop-blur-lg bg-opacity-20 rounded-[30px] shadow-sm border-5 p-4 bg-white  ">
