        ...
        <div className='grid grid-cols-1 md:grid-cols-3 lg:gap-16 gap-10 md:mt-20 mt-10 mx-5 md:mx-0'>
          <div className='group gr col-span-1 w-full grid grid-cols-1 items-center '>
            <div className='col-span-1 flex md:flex-row flex-col justify-between items-center'>
              <div class="lg:w-14 lg:h-14 w-8 h-8 rounded-full bg-[#f0bd07] flex justify-center items-center mb-5 group-hover:bg-[#00c1a2] group-hover:scale-[1.3] transition duration-700 ease-in-out">
            ...
            <div className='col-span-1'>
              ...
              <ul className='mt-3 ml-10 md:ml-5 text-left'>
                <li className='sub-header flex items-start space-x-3'><svg class="flex-shrink-0 w-3.5 h-3.5 text-[#00c1a2] mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                </svg><span>Introduce yourself, your plan and where the place is</span></li>
              </ul>
            </div>
          </div>
          <div className='group col-span-1 w-full grid grid-cols-1'>
            ...
            <div className='col-span-1'>
              ...
              <ul className='mt-3 ml-10 md:ml-5 text-left'>
                <li className='sub-header flex items-start space-x-3'><svg class="flex-shrink-0 w-3.5 h-3.5 text-[#00c1a2] mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                </svg><span>Along the way, we will provide advice to help you</span></li>
              </ul>
            </div>
          </div>
          <div className='group col-span-1 w-full grid grid-cols-1'>
            <div className='col-span-1 flex md:flex-row flex-col justify-start items-center'>
              ...
              <svg className=" flex-shrink-0 w-3.5 h-3.5 text-[#f0bd07] -mt-5 scale-[4] ml-14 group-hover:scale-[6] group-hover:translate-x-6 group-hover:text-[#00c1a2] transition duration-700 ease-in-out" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                  <path className='invisible lg:visible' stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                </svg>
            </div>
            <div className='col-span-1'>
              ...
              <ul className='mt-3 ml-10 md:ml-5 text-left'>
                <li className='sub-header flex items-start space-x-3'><svg class="flex-shrink-0 w-3.5 h-3.5 text-[#00c1a2] mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                </svg><span>There are many people who want to help you as well</span></li>
              </ul>
            </div>
          </div>
        </div>
