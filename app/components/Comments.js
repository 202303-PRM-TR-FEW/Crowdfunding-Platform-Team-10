  ...
  return (
    <div className="p-10 text-center py-20 md:px-12 container mx-auto">
      <div className="flex items-center flex-col py-5 ">
        <p className='w-[24rem] text-base text-black py-5'>- This website rocks! I raised close to $10,000 in less than 48 hours for my nephews medical needs, and your customer service was so prompt and helpful. -</p>
